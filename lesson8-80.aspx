<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="lesson8-80.aspx.cs" Inherits="wording.lesson8_80" %>
<!DOCTYPE HTML>

<html>
	<head>
		<title>Português - Exercício1</title>
		<meta charset="utf-8" />
        ...
        <form id="form1" runat="server">
		    ...
		    <div id="page-wrapper">
			    ...
			    <header id="header" class="alt">
				    <h1><asp:Label ID="Label1" runat="server" Text="Label"></asp:Label><a href="index.html">Português - Exercicio1</a></h1>
				    <nav>
					    <a href="#menu">Menu</a>
				    </nav>
			    </header>
			    ...
			    <nav id="menu">
				    <div class="inner">
					    ...
					    <ul class="links">
						    ...
						    <li><a href="menu.aspx">Área do Aluno</a></li>
					    </ul>
                ...
                <div class="w3-container w3-text-white w3-dark-blue"> 
		            ...
		            <section id="banner">
		                <!-- Content part 1 -->
                        <div class="logo"><span class="#"><img src="../../w3ex001/images/logoW3web.png" width="123" height="91"></span></div>
			            <h2>FASHION</h2>
                        </section>
                ...
                <!-- Wrapper -->
			    <section id="wrapper"> 
                    <div class="container w3-margin">START WRITING</div>
                </section>
                <!-- One -->
		        <section id="one" class="wrapper spotlight style1">
                    <div class="container w3-margin">Write 2</div>
                </section>
			    <!-- content book -->
                <div class="container w3-margin">Write 3</div>
            </div>

            <section id="two" class="wrapper alt spotlight style2">
                <div class="container w3-margin">Write 4</div>
            </section>
            <!-- Two --><!-- Three -->
	        <section id="three" class="wrapper spotlight style3">
	            <div class="container w3-margin">Write 5</div>
            </section>
            <!-- Four -->
	        <section id="four" class="wrapper alt style1">
	            <div class="container w3-margin">Write 6</div>
            </section>
            ...
            <asp:Button ID="Button1" runat="server" Text="Button" Onclick="Button2_Click1" />
