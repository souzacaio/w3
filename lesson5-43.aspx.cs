...
namespace wording
{
    public partial class lesson5_43 : System.Web.UI.Page
    {
        CTO Pcampos = new CTO();
        ...
        public string verificaacao()
        {
            ...
            string consulta = "select id from lesson where id_aluno='" + Pcampos.Session + "'and segmento='lesson5-43' ";
