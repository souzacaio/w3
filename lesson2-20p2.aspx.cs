...
namespace wording
{
    public partial class lesson2_20p2 : System.Web.UI.Page
    {
        CTO Pcampos = new CTO();
        ...
        public void scheckbox()
        {
            ...
            string consulta = "select * from lesson where segmento='lesson2-20p2' and id_aluno = '" + Convert.ToString(Session["user"]) + "'";
            bool resul = false;
            ...
            if (reader.HasRows)
            {
                ...
                if (reader["Pergunta1"].ToString() != "")
                {
                    TextBox1.Checked = true;
                }
                else
                {
                    TextBox1.Checked = false;
                }
                if (reader["Pergunta2"].ToString() != "")
                {
                    TextBox2.Checked = true;
                }
                else
                {
                    TextBox2.Checked = false;
                }
                if (reader["Pergunta5"].ToString() != "")
                {
                    TextBox5.Checked = true;
                }
                else
                {
                    TextBox5.Checked = false;
                }
                if (reader["Pergunta6"].ToString() != "")
                {
                    TextBox6.Checked = true;
                }
                else
                {
                    TextBox6.Checked = false;
                }
                if (reader["Pergunta7"].ToString() != "")
                {
                    TextBox7.Checked = true;
                }
                else
                {
                    TextBox7.Checked = false;
                }
                if (reader["Pergunta8"].ToString() != "")
                {
                    TextBox8.Checked = true;
                }
                else
                {
                    TextBox8.Checked = false;
                }
                if (reader["Pergunta9"].ToString() != "")
                {
                    TextBox9.Checked = true;
                }
                else
                {
                    TextBox9.Checked = false;
                }
                if (reader["Pergunta11"].ToString() != "")
                {
                    TextBox11.Checked = true;
                }
                else
                {
                    TextBox11.Checked = false;
                }
                if (reader["Pergunta12"].ToString() != "")
                {
                    TextBox12.Checked = true;
                }
                else
                {
                    TextBox12.Checked = false;
                }
                if (reader["Pergunta13"].ToString() != "")
                {
                    TextBox13.Checked = true;
                }
                else
                {
                    TextBox13.Checked = false;
                }
                if (reader["Pergunta14"].ToString() != "")
                {
                    TextBox14.Checked = true;
                }
                else
                {
                    TextBox14.Checked = false;
                }
                if (reader["Pergunta15"].ToString() != "")
                {
                    TextBox15.Checked = true;
                }
                else
                {
                    TextBox15.Checked = false;
                }
                if (reader["Pergunta16"].ToString() != "")
                {
                    TextBox16.Checked = true;
                }
                else
                {
                    TextBox16.Checked = false;
                }
        ...
        public string verificaacao()
        {
            ...
            string consulta = "select id from lesson where id_aluno='" + Convert.ToString(Session["user"]) + "'and segmento='lesson2-20p2' ";
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            if (verificaacao() == "insert" & Convert.ToInt32(Session["user"]) > 0)
            {
                ...
                if (TextBox1.Checked)
                {
                    Pcampos.Campo1 = TextBox1.Text = " ";
                }
                else
                {
                    Pcampos.Campo2 = TextBox2.Text = "";
                } if (TextBox5.Checked)
                {
                    Pcampos.Campo5 = TextBox5.Text = " ";
                }
                else
                {
                    Pcampos.Campo5 = TextBox5.Text = "";
                ...
                {
                    Pcampos.Campo9 = TextBox9.Text = " ";
                }
                else
                {
                    Pcampos.Campo9 = TextBox9.Text = "";
                } if (TextBox11.Checked)
                {
                    Pcampos.Campo11 = TextBox11.Text = " ";
                }
                else
                {
                    Pcampos.Campo11 = TextBox11.Text = "";
                } if (TextBox12.Checked)
                {
                    Pcampos.Campo12 = TextBox12.Text = " ";
                }
                else
                {
                    Pcampos.Campo12 = TextBox12.Text = "";
                } if (TextBox13.Checked)
                {
                    Pcampos.Campo13 = TextBox13.Text = " ";
                }
                else
                {
                    Pcampos.Campo13 = TextBox13.Text = "";
                } if (TextBox14.Checked)
                {
                    Pcampos.Campo14 = TextBox14.Text = " ";
                }
                else
                {
                    Pcampos.Campo14 = TextBox14.Text = "";
                } if (TextBox15.Checked)
                {
                    Pcampos.Campo15 = TextBox15.Text = " ";
                }
                else
                {
                    Pcampos.Campo15 = TextBox15.Text = "";
                } if (TextBox16.Checked)
                {
                    Pcampos.Campo16 = TextBox16.Text = " ";
                }
                else
                {
                    Pcampos.Campo16 = TextBox16.Text = "";
