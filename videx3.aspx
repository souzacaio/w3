<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="videx3.aspx.cs" Inherits="wording.videx4" %>
	...
	<div  id="home" class="banner">
		<div class="banner-info">
			...
			<div class="banner-text">
				<h1 class="wow slideInLeft animated" data-wow-delay=".5s"><a href="index.html">VIDEX 3</a></h1>
...
<p>6. What's the answer?</p>
<p>a. What size are you?</p>
<p>- I'm a size 40.</p>
<p>- Yes, I am.</p>
<p>- I like many sizes.</p>
<p>&nbsp;</p>
<p>7. What does Elena need to buy?</p>
<p>
 <asp:TextBox ID="TextBox8" class="w3-input w3-hover-light-blue" runat="server"></asp:TextBox></p>
<p>&nbsp;</p>
<p>8. What does Betty look like?</p>
<p>
