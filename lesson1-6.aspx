<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="lesson1-6.aspx.cs" Inherits="wording.lesson1_61" %>
			...
			<div id="page-wrapper">
				...
				<!-- Header -->
					<header id="header" class="alt">
						<h1>
                            <asp:Label ID="Label1" runat="server" Text="Label"></asp:Label><a href="index.html">COLOR</a></h1>
						<nav>
							<a href="#menu">Menu</a>
						</nav>
					</header>
