<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="livro2.aspx.cs" Inherits="wording.livro2" %>
<!DOCTYPE HTML>

<html>
	<head>
		<title>Português - Livro 2</title>
		<meta charset="utf-8" />
        ...
        <form id="form1" runat="server">
		    ...
		    <div id="page-wrapper">
			    ...
			    <header id="header" class="alt">
				    <h1><asp:Label ID="Label1" runat="server" Text="Label"></asp:Label><a href="index.html">Português - Livro 2</a></h1>
				    <nav>
					    <a href="#menu">Menu</a>
				    </nav>
			    </header>
