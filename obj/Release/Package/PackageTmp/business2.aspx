<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="business2.aspx.cs" Inherits="wording.business2" %>
<!DOCTYPE HTML>
        ...
        <form id="form1" runat="server">
		    ...
		    <div id="page-wrapper">
			    ...
			    <header id="header" class="alt">
				    <h1><asp:Label ID="Label1" runat="server" Text="Label"></asp:Label><a href="index.html">Business 2</a></h1>
				    <nav>
					    <a href="#menu">Menu</a>
				    </nav>
			    </header>
