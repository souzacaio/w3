<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="videx4.aspx.cs" Inherits="wording.videx41" %>
	...
	<div  id="home" class="banner">
		<div class="banner-info">
			...
			<div class="banner-text">
				<h1 class="wow slideInLeft animated" data-wow-delay=".5s"><a href="index.html">VIDEX 4</a></h1>
...
<p>&nbsp;</p>
<div class="w3-container">
  <a class="w3-btn-floating w3-ripple w3-teal">2 Part 2</span></div>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
        <div class="w3-container">
...
A cord of three strands is not quickly broken. </p>
  ...
  <p>Exercises</p>
	...
	<!--//services-->
	<!--work-->
	<div class="welcome work" id="work"></div>
	<!--//work-->
	<!--slid-->
	<div class="slid">
		<div class="container"> 
		  <span class="w3-text-light-blue w3-xxlarge w3-myfont">WORDING IDIOMAS ONLINE</span><br>
          <h6 class="w3-text-white w3-large">Aprender um idioma é fácil se você tentar</h6>
	  </div>
</div>
	<!--//slid-->
	<!--gallery-->
