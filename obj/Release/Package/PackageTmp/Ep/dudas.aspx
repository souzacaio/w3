<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dudas.aspx.cs" Inherits="wording.dudas" %>
<!DOCTYPE HTML>

<html>
	<head>
		<title>Spañol - Dudas</title>
		<meta charset="utf-8" />
        ...
        <form id="form1" runat="server">
		    ...
		    <div id="page-wrapper">
			    ...
			    <header id="header" class="alt">
				    <h1><asp:Label ID="Label1" runat="server" Text="Label"></asp:Label><a href="index.html">Spañol - Dudas</a></h1>
				    <nav>
					    <a href="#menu">Menu</a>
				    </nav>
			    </header>
