<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="videos.aspx.cs" Inherits="wording.videos" %>
<!DOCTYPE HTML>

<html>
	<head>
		<title>Spañol - Videos</title>
		<meta charset="utf-8" />
        ...
        <form id="form1" runat="server">
		    ...
		    <div id="page-wrapper">
			    ...
			    <header id="header" class="alt">
				    <h1><asp:Label ID="Label1" runat="server" Text="Label"></asp:Label><a href="index.html">Spañol - Videos</a></h1>
				    <nav>
					    <a href="#menu">Menu</a>
				    </nav>
			    </header>
