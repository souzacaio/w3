<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dicas.aspx.cs" Inherits="wording.dicas" %>
<!DOCTYPE HTML>

<html>
	<head>
		<title>Spañol - Dicas</title>
		<meta charset="utf-8" />
        ...
        <form id="form1" runat="server">
		    ...
		    <div id="page-wrapper">
			    ...
			    <header id="header" class="alt">
				    <h1><asp:Label ID="Label1" runat="server" Text="Label"></asp:Label><a href="index.html">Spañol - Dicas</a></h1>
				    <nav>
					    <a href="#menu">Menu</a>
				    </nav>
			    </header>
