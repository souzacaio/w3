<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="leccion1.aspx.cs" Inherits="wording.leccion1" %>
<!DOCTYPE HTML>

<html>
	<head>
		<title>Spañol - Lección 1</title>
		<meta charset="utf-8" />
        ...
        <form id="form1" runat="server">
		    ...
		    <div id="page-wrapper">
			    ...
			    <header id="header" class="alt">
				    <h1><asp:Label ID="Label1" runat="server" Text="Label"></asp:Label><a href="index.html">Spañol - Lección 1</a></h1>
				    <nav>
					    <a href="#menu">Menu</a>
				    </nav>
			    </header>
