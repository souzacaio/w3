...
namespace wording
{
    public partial class videx11 : System.Web.UI.Page
    {
        CTO Pcampos = new CTO();
        ...
        public string verificaacao()
        {
            ...
            string consulta = "select id from lesson where id_aluno='" + Convert.ToString(Session["user"]) + "'and segmento='videx11' ";
