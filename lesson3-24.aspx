<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="lesson3-24.aspx.cs" Inherits="wording.lesson3_24" %>
			...
			<div id="page-wrapper">
				...
				<!-- Header -->
					<header id="header" class="alt">
						<h1>
                            <asp:Label ID="Label1" runat="server" Text="Label"></asp:Label><a href="index.html">No Problem!</a></h1>
						<nav>
							<a href="#menu">Menu</a>
						</nav>
					</header>
