<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="business1.aspx.cs" Inherits="wording.business1" %>
<!DOCTYPE HTML>
        ...
        <form id="form1" runat="server">
		    ...
		    <div id="page-wrapper">
			    ...
			    <header id="header" class="alt">
				    <h1><asp:Label ID="Label1" runat="server" Text="Label"></asp:Label><a href="index.html">Business 1</a></h1>
				    <nav>
					    <a href="#menu">Menu</a>
				    </nav>
			    </header>
