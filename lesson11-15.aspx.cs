...
namespace wording
{
    public partial class lesson11_15 : System.Web.UI.Page
    {
          CTO Pcampos = new CTO();
        ...
        public void scheckbox()
        {
            ...
            string consulta = "select * from lesson where segmento='lesson11-15' and id_aluno = '" + Convert.ToString(Session["user"]) + "'";
            bool resul = false;
        ...
        public string verificaacao()
        {
            ...
            string consulta = "select id from lesson where id_aluno='" + Convert.ToString(Session["user"]) + "'and segmento='lesson11-15' ";
