...
namespace wording
{
    public partial class lesson7_62 : System.Web.UI.Page
    {
        CTO Pcampos = new CTO();
        ...
        public string verificaacao()
        {
            ...
            string consulta = "select id from lesson where id_aluno='" + Pcampos.Session + "'and segmento='lesson7-62' ";
