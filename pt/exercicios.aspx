<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Exercicios.aspx.cs" Inherits="wording.Exercicios" %>
<!DOCTYPE HTML>

<html>
	<head>
		<title>Português - Exercícios</title>
		<meta charset="utf-8" />
        ...
        <link rel="shortcut icon" href="../home/imagem/logo.ico" type="image/x-icon" />        <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
        ...
        <form id="form1" runat="server">
		    ...
		    <div id="page-wrapper">
			    ...
			    <header id="header" class="alt">
				    <h1><asp:Label ID="Label1" runat="server" Text="Label"></asp:Label><a href="index.html">Português - Exercicios</a></h1>
				    <nav>
					    <a href="#menu">Menu</a>
				    </nav>
			    </header>
