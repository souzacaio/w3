<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="livro4.aspx.cs" Inherits="wording.livro4" %>
<!DOCTYPE HTML>

<html>
	<head>
		<title>Português - Livro 4</title>
		<meta charset="utf-8" />
        ...
        <form id="form1" runat="server">
		    ...
		    <div id="page-wrapper">
			    ...
			    <header id="header" class="alt">
				    <h1><asp:Label ID="Label1" runat="server" Text="Label"></asp:Label><a href="index.html">Português - Livro 4</a></h1>
				    <nav>
					    <a href="#menu">Menu</a>
				    </nav>
			    </header>
